    ...
    <q-page class="text-center text-h4 q-pa-lg">
      <q-card class=" q-pa-md">
        <div class="row">
          ...
          <div class="col">
            <q-btn label="Edit Account"> </q-btn>
          </div>
        </div>
        ...
        <q-tab-panels v-model="tab" animated>
          <q-tab-panel name="dances">
            <div class="q-pa-md">
              ...
              <div class="row q-pa-xm">
                <div class="col-2">
                  <span class="text-h3">Dances</span>
                </div>
                <div class="col-8">
                  <q-btn label="Add Dances"> </q-btn>
                </div>
              </div>
              <div class="q-pa-md">
                  ...
                  <q-item>
                    ...
                    <q-item-section top side>
                      <div class="text-black q-gutter-xs">
                        <span class="text-weight-medium">ACTIONS</span>
                      </div>
                    </q-item-section>
                  </q-item>
                </q-list>
                <q-list
                  v-for="(dance, index) in dancelist"
                  :name="dance.Name"
                  :key="index"
                  bordered
                ...
                >
                  <q-item>
                    ...
                    <q-item-section top>
                      <q-item-label lines="1">
                        <span class="text-weight-medium">{{ dance.Name }}</span>
                      </q-item-label>
                    </q-item-section>
                    <q-item-section top side>
          ...
          <q-tab-panel name="instruments">
            <div class="q-pa-md">
              ...
              <div class="row q-pa-xm">
                <div class="col-2">
                  <span class="text-h3">Instruments</span>
                </div>
                <div class="col-8">
                  <q-btn label="Add Instruments"> </q-btn>
                </div>
              </div>
              <div class="q-pa-md">
          ...
          <q-tab-panel name="pictures">
            <div class="q-pa-md">
              ...
              <div class="row q-pa-xm">
                <div class="col-2">
                  <span class="text-h3">Pictures</span>
                </div>
                <div class="col-8">
                  <q-btn label="Add Pictures"> </q-btn>
                </div>
              </div>
              <div class="q-pa-md">
                <q-list bordered class="rounded-borders">
          ...
          <q-tab-panel name="songs">
            <div class="q-pa-md">
              ...
              <div class="row q-pa-xm">
                <div class="col-2">
                  <span class="text-h3">Songs</span>
                </div>
                <div class="col-8">
                  <q-btn label="Add Songs"> </q-btn>
                </div>
              </div>
              <div class="q-pa-md">
                <q-list bordered class="rounded-borders">
